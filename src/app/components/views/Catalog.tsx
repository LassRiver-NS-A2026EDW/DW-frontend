...
import { BookGridSkeleton } from "../shared/LoadingSkeleton";
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden bg-muted">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-2 bg-white/90 dark:bg-black/60 backdrop-blur-sm rounded-full hover:scale-110 transition-transform"
                  >
                    <Heart
                      className={`h-5 w-5 ${
                  ...
                  {!book.available && (
                    <div className="absolute bottom-0 left-0 right-0 bg-destructive/90 text-destructive-foreground py-1 px-2 text-xs text-center">
                      No disponible
                    </div>
                  )}
                </div>
