...
import { Home, BookOpen, Heart, MessageSquare, User, Settings, LayoutDashboard, Menu } from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-1">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-2">
              <img src="figma:asset/imagen.png" alt="LassRiver NS" className="h-12 w-auto" />
            </div>
          )}
          <button
