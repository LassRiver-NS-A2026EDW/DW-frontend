...
import { Home, BookOpen, Heart, MessageSquare, User, LayoutDashboard, Menu, Library, Clock } from "lucide-react";
...
export function Sidebar() {
  ...
  const navigation = [
    ...
    { id: "reservations", label: "Reservas", icon: Clock, roles: ["user", "librarian", "admin"] },
